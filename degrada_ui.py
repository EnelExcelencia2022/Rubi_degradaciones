...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -256, 1047, 1622))
        ...
        self.comboBox_wtg = QtWidgets.QComboBox(self.frame)
        self.comboBox_wtg.setGeometry(QtCore.QRect(210, 60, 81, 31))
        self.comboBox_wtg.setObjectName("comboBox_wtg")
        ...
        self.comboBox_pala = QtWidgets.QComboBox(self.frame)
        self.comboBox_pala.setEnabled(False)
        self.comboBox_pala.setGeometry(QtCore.QRect(942, 380, 51, 22))
        self.comboBox_pala.setObjectName("comboBox_pala")
        self.label_pala = QtWidgets.QLabel(self.frame)
        self.label_pala.setEnabled(False)
        self.label_pala.setGeometry(QtCore.QRect(900, 380, 41, 21))
        self.label_pala.setObjectName("label_pala")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Wayra - curvas"))
        ...
        self.label_15.setText(_translate("MainWindow", "Turbina:"))
        ...
        self.label_pala.setText(_translate("MainWindow", "Pala:"))
